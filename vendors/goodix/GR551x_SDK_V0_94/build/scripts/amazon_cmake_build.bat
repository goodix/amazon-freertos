...
@set TOOL_PATH=%AFR_ROOT_DIR%\vendors\goodix\GR551x_SDK_V0_94\build\binaries
...
@set FW_ENCRYPT_SIGN_TOOL_PATH=%AFR_ROOT_DIR%\vendors\goodix\GR551x_SDK_V0_94\build\binaries\encrypt_tools
...
::%TOOL_PATH%\ble_tools.exe  --cfg=%AFR_ROOT_DIR%\vendors\goodix\GR551x_SDK_V0_94\build\config\custom_config.h --mode=gen --bin=%OBJ_DIR_PATH%\%TARGET%.bin --outdir=%OUTPUT_DIR_PATH% --app_name=%TARGET_APP%
%TOOL_PATH%\ble_tools.exe  --cfg=%AFR_ROOT_DIR%\vendors\goodix\GR551x_SDK_V0_94\toolchain\gr551x\source\arm\custom_config.h --mode=gen --bin=%OBJ_DIR_PATH%\%TARGET%.bin --outdir=%OUTPUT_DIR_PATH% --app_name=%TARGET_APP%
...
::%TOOL_PATH%\ble_tools.exe --cfg=%AFR_ROOT_DIR%\vendors\goodix\GR551x_SDK_V0_94\build\scripts\simulation_unenc.txt --mode=merge_bin --input_path=%OUTPUT_DIR_PATH% --bin=%OUTPUT_DIR_PATH%\%TARGET_APP%_sim.bin  --out_bin_size=0x80000 >nul
