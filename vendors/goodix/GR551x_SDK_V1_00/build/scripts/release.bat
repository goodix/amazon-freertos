...
%TOOL_PATH%\ble_tools.exe  --cfg=..\Src\config\custom_config.h --mode=gen --bin=%OBJ_DIR_PATH%\%TARGET%.bin --outdir=%OUTPUT_DIR_PATH% --app_name=%TARGET_APP%
...
%TOOL_PATH%\ble_tools.exe --cfg=..\..\..\..\..\build\scripts\simulation_unenc.txt --mode=merge_bin --input_path=%OUTPUT_DIR_PATH% --bin=%OUTPUT_DIR_PATH%\%TARGET_APP%_sim.bin  --out_bin_size=0x80000 >nul
